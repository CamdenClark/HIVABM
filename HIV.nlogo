...
to-report find-partner ; This finds a partner to make a node with
...
;;The following is all layout stuff for the visuals of the model.
to resize-nodes
  ask turtles [ set size .25 * sqrt count link-neighbors ]
end
